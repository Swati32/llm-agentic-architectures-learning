...
* [Evaluation Criteria Across LLM, RAG, Agent, and Multi-Agent Systems](EVALUATION_CRITERIA.md): not an experiment, a decision framework synthesized from the experiments above plus current research, on which evaluation criteria matter for which kind of system and how to use that to decide something. [Live dashboard](https://swati-evaluation-criteria.streamlit.app/).
