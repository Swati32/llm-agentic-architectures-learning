...
def build_record(shape_key: str, module, example: dict, run) -> dict:
    return {
        "shape": shape_key,
        "shape_name": module.NAME,
        ...
        "redundant_retrievals": run.redundant_retrievals,
        "redundant_step_rate": run.redundant_step_rate,
